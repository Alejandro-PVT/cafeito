...
async function GET(request) {
    try {
        const results = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT p.*, c.name as category_name FROM products p
...
async function POST(request) {
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`INSERT INTO products (name, description, category_id, price, image_url, stock)
       VALUES (?, ?, ?, ?, ?, ?)`, [
            name,
            description,
            category_id,
